...
index_path = os.path.join(os.path.dirname(**file**), “index.html”)
if os.path.exists(index_path):
with open(index_path, “r”) as f:
return HTMLResponse(content=f.read())
return HTMLResponse(content=”<html><body><h2>VibeLenz VIE API - Running</h2><p>POST /analyze to analyze a conversation.</p><p><a href='/docs'>API Docs</a></p></body></html>”)
            ...
            "recommendations": [
                {
                    ...
                    "body": "Safety analysis could not be completed. Treat this conversation with caution.",
                }
            ],
        },
        status_code=200,
...
from safety_detector import SIGNAL_WEIGHTS, CRITICAL_SIGNALS, HIGH_SIGNALS, MEDIUM_SIGNALS
return {
